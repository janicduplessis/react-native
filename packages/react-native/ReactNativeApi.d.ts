 ...
 *
 * @generated SignedSource<<8ddcacdcb916fbad8b133fef393e3f99>>
 *
...
declare const $$SafeAreaView_INTERNAL_DO_NOT_USE: typeof SafeAreaView_default_2
...
declare const SafeAreaView_default: typeof $$SafeAreaView_INTERNAL_DO_NOT_USE
...
declare type $$SafeAreaView_INTERNAL_DO_NOT_USE =
  typeof $$SafeAreaView_INTERNAL_DO_NOT_USE
...
declare type DirectEventProps = {
  ...
  readonly onSafeAreaInsetsChange?: (
...
declare type SafeAreaInsets = {
  readonly bottom: number
  readonly left: number
  readonly right: number
  readonly top: number
}
declare type SafeAreaInsetsChangeEvent = NativeSyntheticEvent<{
  readonly frame: LayoutRectangle
  readonly insets: SafeAreaInsets
}>
declare type SafeAreaView = typeof SafeAreaView
declare function SafeAreaView_default_2(
  props: ViewProps & {
    ref?: React.Ref<HostInstance>
  },
): React.ReactNode
...
declare type WindowSafeAreaInsets = {
  bottom: number
  left: number
  right: number
  top: number
...
export {
  ...
  ActivityIndicator, // cb3baebf
  ActivityIndicatorInstance, // a82dd4e7
  ActivityIndicatorProps, // c9fb2776
  Alert, // a398a509
  ...
  DeviceInfo, // db26f5e4
  DeviceInfoConstants, // 148c17ed
  DimensionValue, // b163a381
  Dimensions, // 6e9b417f
  DimensionsPayload, // 8251f7f2
  DisplayMetrics, // 5801c350
  DisplayMetricsAndroid, // 5ad0b971
  DrawerLayoutAndroid, // 9789fb75
  DrawerLayoutAndroidInstance, // c0694352
  DrawerLayoutAndroidProps, // 2a3b9a3e
  ...
  FlatList, // f7dfb7bf
  FlatListInstance, // 4cde6870
  FlatListProps, // eb05aa31
  FocusEvent, // 850f1517
  ...
  Image, // 4845ad61
  ImageBackground, // 601e01e7
  ImageBackgroundInstance, // 3bb44053
  ImageBackgroundProps, // 46039e37
  ...
  KeyUpEvent, // 57f832c5
  Keyboard, // 49414c97
  KeyboardAvoidingView, // 3f0523c3
  KeyboardAvoidingViewInstance, // 668649df
  KeyboardAvoidingViewProps, // b3f0f986
  ...
  RefreshControl, // f51d7fa6
  RefreshControlInstance, // e3123c95
  RefreshControlProps, // 3b735108
